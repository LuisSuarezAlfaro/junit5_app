package org.aluissuarez.junit5app.ejemplo.models;

import org.aluissuarez.junit5app.ejemplo.exceptions.DineroInsuficienteException;
...
class CuentaTest {
    ...
    class CuentaTestNombreSaldo {
        ...
        void testNombreCuenta(TestInfo testInfo, TestReporter testReporter) {
            ...
            assertEquals(expected, actual, () -> "El nombre de la cuentan no es el que se esperaba: se esperaba " + expected + " sin embargo fue " + actual);
            assertTrue(actual.equals("Luis"), () -> "Nombre cuenta esperada debe ser igual a la real");
        }
        ...
        void testReferenciaCuenta() {
            Cuenta actual = new Cuenta("Luis Suarez", new BigDecimal("8900.9997"));
            Cuenta expected = new Cuenta("Luis Suarez", new BigDecimal("8900.9997"));
    ...
    class CuentaOperacionesTest{
        ...
        void testTransferirDineroCuentas() {
            Cuenta cuenta1 = new Cuenta("Luis", new BigDecimal("2500"));
            Cuenta cuenta2 = new Cuenta("Monica", new BigDecimal("1500.8989"));
    ...
    void testRelacionBancoCuentas() {
        ...
        assertAll(
                ...
                () -> assertTrue(banco.getCuentas().stream()
                        ...
                        .isPresent()),
                () -> assertTrue(banco.getCuentas().stream()
                        .anyMatch(c -> c.getPersona().equals("Monica")))
        );
    }
    ...
    class SistemPropertiesTest{
        ...
        @Test
        @EnabledIfSystemProperty(named = "user.name", matches = "a_lui")
        void testUserName() {
        }
    ...
    class PruebasParametrizadasTest{
        ...
        @ParameterizedTest(name = "numero {index} ejecutando con valor {0} - {argumentsWithNames}")
        @CsvSource({"200,100,Luis,Alberto","250,200,Monica,Monica","300,300,Luisa,Laura","510,500,Catalina,Catalina","750,700,Johana,Johana","1000.12345,1000.12345,Fanny,Fanny"})
